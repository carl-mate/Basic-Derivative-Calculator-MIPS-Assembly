...
Overview:
-The simple derivative calculator was written in MIPS Assembly using the MARS MIPS Simulator.
...
-Written by Carl Joseph P. Mate and Sophia Marie C. Casas

Valid inputs:
-Integers
-Minus sign (-) and plus sign (+). The authors decided to leave out the multiplication sign
in favor of simplicity. Therefore, functions such as 4*x^5 are not allowed and should be simplified to 4x^5.
